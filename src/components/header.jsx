  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex justify-center items-center">
        <a
          className='cursor-pointer  px-4  flex items-center font-geist bg-white py-2 rounded-sm mr-5 text-[#144944]'
          onClick={(e) => {
            e.preventDefault();
            nav('/schedule') 
          }} style={{fontSize:"10px",fontWeight:"800"}}
        >SCHEDULE DEMO  <GoArrowUpRight className='text-[#144944]' /></a>
      </div>
